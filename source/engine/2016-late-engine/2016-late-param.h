...
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_DEPTH = 10;
...
// 元の値 = 823
// [PARAM] min:500,max:1500,step:3,interval:2,time_rate:1
PARAM_DEFINE PARAM_NULL_MOVE_DYNAMIC_ALPHA = 809;

// 元の値 = 67
// [PARAM] min:50,max:100,step:2,interval:2,time_rate:1
...
// 元の値 = 256
// [PARAM] min:128,max:400,step:4,interval:1,time_rate:1
...
// historyの値によってreductionするときの係数
// 元の値 = 256
// [PARAM] min:128,max:384,step:1,interval:2,time_rate:1
PARAM_DEFINE PARAM_IID_MARGIN_ALPHA = 262;
...
// 元の値 = 483
// [PARAM] min:400,max:700,step:5,interval:2,time_rate:1
PARAM_DEFINE PARAM_RAZORING_MARGIN1 = 493;

// 元の値 = 570
// [PARAM] min:400,max:700,step:5,interval:2,time_rate:1
PARAM_DEFINE PARAM_RAZORING_MARGIN2 = 565;
...
PARAM_DEFINE PARAM_FUTILITY_MOVE_COUNT_ALPHA1 = 287;
...
PARAM_DEFINE PARAM_FUTILITY_MOVE_COUNT_BETA1 = 1039;
