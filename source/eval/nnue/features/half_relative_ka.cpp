// NNUE評価関数の入力特徴量HalfRelativeKAの定義
...
inline IndexType HalfRelativeKA<AssociatedKing>::MakeIndex(
...
// 駒の情報を取得する
template <Side AssociatedKing>
inline void HalfRelativeKA<AssociatedKing>::GetPieces(
...
template <Side AssociatedKing>
void HalfRelativeKA<AssociatedKing>::AppendActiveIndices(
...
template <Side AssociatedKing>
void HalfRelativeKA<AssociatedKing>::AppendChangedIndices(
    const Position& pos, Color perspective,
